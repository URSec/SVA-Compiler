...
/// This pass optimizes loads from and stores to the return address's frame
/// index for jump returns.
...
void initializeX86OptimizeJumpReturnAddressPass(PassRegistry &);
